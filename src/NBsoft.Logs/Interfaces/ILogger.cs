...
namespace NBsoft.Logs.Interfaces
{
    public interface ILogger : IDisposable
    {
        ...
        void WriteError(string component, string process, string context, Exception exception, DateTime? dateTime = default(DateTime?));
        void WriteFatalError(string component, string process, string context, Exception exception, DateTime? dateTime = default(DateTime?));
    }
}
